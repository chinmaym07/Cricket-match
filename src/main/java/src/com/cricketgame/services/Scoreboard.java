...
public class Scoreboard {
    private static void printBattingScorecard(List<Player> playerArr, Innings innings) {
    ...
    private static void printWicketsHistory(List<WicketsHistory> wicketsHistory) {
        int count = 0;
        System.out.println("Fall of Wickets");
        for (WicketsHistory wickets : wicketsHistory) {
            System.out.printf(wickets.getRunScored() + "-" + wickets.getWicketsDown() + " (" + wickets.getBatsmanName() + ", %4.1f)", wickets.getWicketsFallenInOver());
            count++;
    ...
    private static void printBowlingStats(List<Player> players) {
    ...
    private static void printingScoreCard(String teamName, List<Player> battingTeamPlayersArr, Innings innings, List<Player> bowlingTeamPlayersArr, boolean secondInnings) {
        if (secondInnings)
